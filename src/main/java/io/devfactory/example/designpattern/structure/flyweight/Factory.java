package io.devfactory.example.designpattern.structure.flyweight;
...
public class Factory {
  ...
  private Flyweight getSharedObject(String className) {
    try {
      final Class<?> clazz = Class.forName("io.devfactory.example.designpattern.structure.flyweight.service." + className);
