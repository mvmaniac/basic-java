package io.devfactory.example.refactoring._04_long_parameter_list._16_combine_functinos_into_class;
...
public class StudyPrinter {
  ...
  public StudyPrinter(int totalNumberOfEvents, List<Participant> participantList) {
  ...
  private String checkMark(Map<Integer, Boolean> homework) {
    ...
    for (int i = 1; i <= this.totalNumberOfEvents; i++) {
      if (homework.containsKey(i) && Boolean.TRUE.equals(homework.get(i))) {
