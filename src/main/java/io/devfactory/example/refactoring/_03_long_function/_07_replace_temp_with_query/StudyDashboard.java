package io.devfactory.example.refactoring._03_long_function._07_replace_temp_with_query;
...
public class StudyDashboard {
  ...
  private double getRate(int totalNumberOfEvents, Participant participant) {
  ...
  private String getMarkdownForParticipant(int totalNumberOfEvents, Participant participant) {
    return String.format("| %s %s | %.2f%% |\n", participant.username(), checkMark(participant, totalNumberOfEvents), getRate(totalNumberOfEvents, participant));
  }
