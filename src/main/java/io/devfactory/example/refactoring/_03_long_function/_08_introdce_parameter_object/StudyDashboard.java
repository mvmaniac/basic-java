package io.devfactory.example.refactoring._03_long_function._08_introdce_parameter_object;
...
public class StudyDashboard {
  ...
  private String getMarkdownForParticipant(Participant participant) {
    return String.format("| %s %s | %.2f%% |\n", participant.username(), checkMark(participant), getRate(participant));
  }
